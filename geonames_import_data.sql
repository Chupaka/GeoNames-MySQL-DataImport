...
ALTER TABLE countryinfo ENABLE KEYS;

SELECT '########## Loading continentCodes.txt... ##########';
ALTER TABLE continentCodes DISABLE KEYS;
...
ALTER TABLE postalCodes ENABLE KEYS;
